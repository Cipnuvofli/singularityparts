...
class Branch_Inventory_Return extends CI_Controller {
	...
	{
		return 'Branch Inventory Return';
	}
    ...
    function index()
    {
		...
		//load view
		$this->load->library('Grocery_CRUD');
        $this->grocery_crud->set_table('branch_inventory_return');
