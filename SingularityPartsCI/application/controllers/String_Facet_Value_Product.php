...
class String_Facet_Value_Product extends CI_Controller {
	...
	{
		return 'String Facet Values - Products';
	}
    ...
    function index()
    {
		...
		//load view
		$this->load->library('Grocery_CRUD');
        $this->grocery_crud->set_table('string_facet_value_product');
