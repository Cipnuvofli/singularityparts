...
class float_facet_value_vehicle extends CI_Controller {
	...
	{
		return 'Float Facet Value vehicle';
	}
    ...
    function index()
    {
		...
		//load view
		$this->load->library('Grocery_CRUD');
        $this->grocery_crud->set_table('float_facet_value_vehicle');
