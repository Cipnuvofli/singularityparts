...
class product_string_facet_value extends CI_Controller {
	...
	{
		return 'Product String Facet Value';
	}
    ...
    function index()
    {
		...
		//load view
		$this->load->library('Grocery_CRUD');
        $this->grocery_crud->set_table('product_string_facet_value');
