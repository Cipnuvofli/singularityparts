...
class Bool_Facet_Value_Vehicle extends CI_Controller {
	...
	{
		return 'Bool Facet Values - Vehicles';
	}
    ...
    function index()
    {
		...
		//load view
		$this->load->library('Grocery_CRUD');
        $this->grocery_crud->set_table('bool_facet_value_vehicle');
