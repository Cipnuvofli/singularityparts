...
class Int_Facet_Value_Vehicle extends CI_Controller {
	...
	{
		return 'Int Facet Values - Vehicles';
	}
    ...
    function index()
    {
		...
		//load view
		$this->load->library('Grocery_CRUD');
        $this->grocery_crud->set_table('int_facet_value_vehicle');
