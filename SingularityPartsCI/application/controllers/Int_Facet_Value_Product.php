...
class Int_Facet_Value_Product extends CI_Controller {
	...
	{
		return 'Int Facet Values - Product';
	}
    ...
    function index()
    {
		...
		//load view
		$this->load->library('Grocery_CRUD');
        $this->grocery_crud->set_table('int_facet_value_product');
