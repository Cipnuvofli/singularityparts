...
class Branch_Inventory_Received_Date extends CI_Controller {
	...
	{
		return 'Branch Inventory Received Dates';
	}
    ...
    function index()
    {
		...
		//load view
		$this->load->library('Grocery_CRUD');
        $this->grocery_crud->set_table('branch_inventory_received_date');
