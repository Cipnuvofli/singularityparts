...
class Branch_Inventory_Request_Product extends CI_Controller {
	...
	public static function has_access()
	{
		...
		if(!$CI->RBAC_model->has_permission(
				...
				'branch_inventory_request_product',
				array(	
	...
	{
		return 'Branch Inventory Request Products';
	}
    ...
    function index()
    {
		...
		//load view
		$this->load->library('Grocery_CRUD');
        $this->grocery_crud->set_table('branch_inventory_request_product');
