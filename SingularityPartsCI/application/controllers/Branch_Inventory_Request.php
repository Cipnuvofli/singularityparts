...
class Branch_Inventory_Request extends CI_Controller {
	...
	{
		return 'Branch Inventory Request';
	}
    ...
    function index()
    {
		...
		//load view
		$this->load->library('Grocery_CRUD');
        $this->grocery_crud->set_table('branch_inventory_request');
