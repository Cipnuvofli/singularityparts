...
/* ================= BEGIN CONSTANTS ========================================*/
	...
	const COMBOS_PER_SECOND = 100000000000000000;
...
/* ================= END CONSTANTS ========================================*/
	...
	*/
	public function isStrongEnoughPassword($pass)
	{
		$days_to_crack = checkStrength($pass);
		if($days_to_crack < self::REQUIRED_MIN_DAYS)
		{
			return false;
		}
		return true;
	 ...
	 */
	public function checkStrength($pass)
	{
		...
		$seconds_to_crack = $total_combos / self::COMBOS_PER_SECOND;
		$days_to_crack = $seconds_to_crack / 3600 / 24;
		
		return round($days_to_crack * self::AVERAGE_STRENGTH_COMPARISON);
	}
}
?>